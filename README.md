...
- Click this badge to clone this repo to a new repl in Replit -> https://replit.com/new/github/Gunthersuper/discord-active-developer-badgee
...
- Add your token to Secrets (key - token)
- Click the green "Run" button at the top.
- Wait for it to print 'DONE | Application/Bot is up and running. 
...
- Go to OAuth2 and make invite links. It needs only Send text and Read message history permissions.
